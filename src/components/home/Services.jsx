  ...
  return (
    <div className='m-auto w-[90vw] lg:mt-28 section font_albertsans bg-white panel'>
      ...
      <div className='flex flex-col  justify-center mx-auto max-w-7xl'>
        ...
        <div className='flex  gap-10 flex-row-reverse items-center justify-between lg:mt-20 mt-5'>
          <div>
            <div className='flex flex-col gap-4'>
              <p className='md:text-3xl text-2xl text-darkblue '>web/mobile Development</p>
