...
const projectImages = {
  ...
  mediqueue: '/assets/mediqueue.png', 
  mern: '/assets/auth.png',
  portfolio: '/assets/portfolio.png',
  geritch: '/assets/geritch.png',
  sumtext: '/assets/sumtext.png'
};
...
const projectsList = [
  {
    ...
    name: "SheScreen",
    description: "Developed a cervical cancer screening system to enhance medical accuracy and streamline patient-doctor workflows. Built admin, doctor, and patient dashboards using Next.js.",
  ...
  {
    image: projectImages.mediqueue,
    name: "Mediapp",
    description: "Created a medical app that allows patients to submit symptoms and receive AI-predicted diagnoses. The app includes a feedback system for continuous improvement.",
    github: "https://github.com/kristinenyaga/mediapp_frontend",
    category: "HealthTech",
    bannerColor: "bg-[#927de7]", 
    techStack: ["Next.js", "TailwindCSS", "Express.js", "MySQL"],
    size: "medium"
  },
  {
    image: projectImages.mern,
    name: "Authentication",
    description: "Crafted using Node.js and React, to provide security measures and user-friendly account recovery. The authentication app incorporates Two-Factor Authentication (2FA).",
  ...
  {
    image: projectImages.geritch,
    name: "Restaurant",
    description: "Developed a full-stack online marketplace application using React.js for the frontend and Node.js with Express.js for the backend. Integrated Stripe API for payment processing.",
  ...
  {
    image: projectImages.sumtext,
    name: "Text Summarizer",
    description: "Developed a text summarization application using React, enabling users to condense lengthy texts into concise summaries efficiently.",
